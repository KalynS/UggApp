      ...
      return (
        <div >
          <Navbar bg="light" expand="lg">
            <Navbar.Brand href="#home"><img src="./images/UGG_logo.png" alt="" width="100px" height="70px"/></Navbar.Brand>
            <Navbar.Toggle aria-controls="basic-navbar-nav" />
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="mr-auto">
                <NavDropdown title="WOMEN" id="basic-nav-dropdown" className="blackwords">
                ...
                <NavDropdown title="MEN"  id="basic-nav-dropdown" className="blackwords">
                  <NavDropdown.Item href="#action/3.1">FEATURED</NavDropdown.Item>
                  <NavDropdown.Item href="#action/3.2">
                    FOOTWEAR
                  </NavDropdown.Item>
                ...
                <NavDropdown title="KIDS"  id="basic-nav-dropdown" className="blackwords">
                ...
                <NavDropdown title="HOME & GIFTS" id="basic-nav-dropdown" className="blackwords">
                ...
                <NavDropdown title="SALE" id="basic-nav-dropdown" className="blackwords">
